...
echo "✅ Changed directory to 'contracts'"
...
sed -i '/DONATION_POOL_PROGRAM_ID/d' backend/.env.example
sed -i '/NFT_TRACKER_PROGRAM_ID/d' backend/.env.example
...
sed -i '/VITE_DONATION_POOL_PROGRAM_ID/d' frontend/.env.example
sed -i '/VITE_NFT_TRACKER_PROGRAM_ID/d' frontend/.env.example
